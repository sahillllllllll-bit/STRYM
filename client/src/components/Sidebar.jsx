...
const  {signOut}= useClerk();
  ...
  return (
    <div className={`w-60 xl:w-70 bg-white border-r border-gray-200 flex flex-col justify-between items-center  max-sm:absolute top-0 bottom-0 z-20
    ${sidebaropen ? 'translate-x-0': 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
      <div className="w-full">
        <img onClick={()=> Navigate('/')} src={assets.logo} className='w-26 ml-7 my-2 cursor-pointor' alt="" />
