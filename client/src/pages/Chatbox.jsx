...
import { dummyFollowingData, dummyMessagesData, dummyUserData } from '../assets/assets'
...
<div ref={messageEndRef}/>
 ...
 <div className="px-4">
    <div className="flex items-center  gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto  border border-gray-200 shadow rounded-full mb-5">
        <input type="text" placeholder='type a Message...' className='flex-1 outline-none text-slate-700' onKeyDown={e=>e.key==='Enter' && sendMessage()} onChange={(e)=> setText(e.target.value )} value={text} />
        <label htmlFor="image">
            {
        ...
        <button className='bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800  active:scale-95 p-2 cursor-pointer rounded-full  text-white'>
